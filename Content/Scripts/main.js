...
app.controller('RepsController', function()
{
    ...
    //Actions
    this.actions = [];
    var pushupAction = new Action("Do Pushups", this.player);
    var situpAction = new Action("Do Situps", this.player);
    var sprintAction = new Action("Run Sprints", this.player);
    var benchpressAction = new Action("Do Benchpresses", this.player);
    var squatAction = new Action("Do Squats", this.player);
    var deadliftAction = new Action("Do Deadlifts", this.player);
    var cleanAction = new Action("Do Cleans", this.player);
